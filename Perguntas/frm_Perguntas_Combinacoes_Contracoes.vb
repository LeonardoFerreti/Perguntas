Public Class frm_Perguntas_Combinacoes_Contracoes
    ...
    Private Function validaDados() As Boolean
        ...
        TENTATIVAS_TELA_COMBINACOES_CONTRACOES += 1

        If Not (TextBox1.Texto.ToLower.Trim.Equals(TextBox1.Tag.ToString)) Then
            validaDados = False
            TrataErro.SetError(Label14, "Reescreva corretamente a combinação.")
            If TENTATIVAS_TELA_COMBINACOES_CONTRACOES < NUMERO_MAXIMO_TENTATIVAS_COM_PERDA Then
                PONTUACAO_TELA_COMBINACOES_CONTRACOES -= DIMINUIR_ERRO_TELA_COMBINACOES_CONTRACOES
            End If
        End If
